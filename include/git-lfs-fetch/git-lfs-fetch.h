...
nlohmann::json oids_to_payload(const std::vector<LfsMd> &items) {
...
std::vector<nlohmann::json> fetch_urls(const std::string &lfs_url,
                                       ...
                                       const std::vector<LfsMd> &metadatas) {
...
void move_files(const std::vector<LfsMd> &metadata,
